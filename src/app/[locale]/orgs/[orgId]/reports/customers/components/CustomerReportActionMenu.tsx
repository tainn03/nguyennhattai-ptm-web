...
type CustomerReportActionMenuProps = {
  actionPlacement?: "start" | "center" | "end";
  onExport?: () => void;
};

const CustomerReportActionMenu = ({ actionPlacement, onExport }: CustomerReportActionMenuProps) => {
...
export default CustomerReportActionMenu;
