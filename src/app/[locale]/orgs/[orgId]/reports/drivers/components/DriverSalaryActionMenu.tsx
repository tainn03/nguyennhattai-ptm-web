...
type DriverSalaryActionMenuProps = {
  actionPlacement?: "start" | "center" | "end";
  onExport?: () => void;
};

const DriverSalaryActionMenu = ({ actionPlacement, onExport }: DriverSalaryActionMenuProps) => {
...
export default DriverSalaryActionMenu;
