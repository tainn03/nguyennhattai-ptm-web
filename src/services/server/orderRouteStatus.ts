 ...
 */
export const createOrderRouteStatusByGraphQL = async (
  jwt: string,
  entity: OrderRouteStatusInputForm
): Promise<OrderRouteStatusInfo> => {
 ...
 */
export const updateOrderRouteStatusByGraphQL = async (
  jwt: string,
  entity: OrderRouteStatusInputForm,
  currentRouteStatuses?: Partial<OrderRouteStatusInfo>
): Promise<OrderRouteStatusInfo> => {
 ...
 */
export const upsertOrderRouteStatusByGraphQL = async (
  jwt: string,
  entity: OrderRouteStatusInputForm,
  currentRouteStatuses?: Partial<OrderRouteStatusInfo>
): Promise<OrderRouteStatusInfo> => {
  if (entity.id) {
    return updateOrderRouteStatusByGraphQL(jwt, entity, currentRouteStatuses);
  }
  return createOrderRouteStatusByGraphQL(jwt, entity);
};
